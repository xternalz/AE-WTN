...
# Two-branch?
_C.MODEL.ROI_HEADS.TWO_BRANCH = False
...
# WTN's reconstruction loss type ("L2" or "smoothL1")
_C.MODEL.ROI_BOX_HEAD.RECONST_LOSS = "L2"
# WTN's reconstruction loss weight
_C.MODEL.ROI_BOX_HEAD.RECONST_W = 1.0
